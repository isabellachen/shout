...
<div id="page" class="site">
    ...
    <div class="site-branding_header">
      <div class="site-branding">
        ...
        $shout_theme_description = get_bloginfo( 'description', 'display' );
        if ( $shout_theme_description || is_customize_preview() ) :
          ?>
          <p class="site-description"><?php echo $shout_theme_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
        <?php endif; ?>
      </div><!-- .site-branding -->
